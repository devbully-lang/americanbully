      ...
      <div className="container mx-auto px-6 py-16">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            <h3 className="text-lg font-bold text-white">Our Program</h3>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/reviews" className="opacity-80 hover:opacity-100 transition-opacity">Reviews</Link></li>
      ...
      <div className="py-6 border-t border-white/10">
        <div className="container mx-auto px-6 flex flex-col md:flex-row justify-between items-center text-center md:text-left">
          <p className="text-sm opacity-60 mb-4 md:mb-0">
            &copy; {new Date().getFullYear()} 601 Bullies LLC. All Rights Reserved.
          </p>
