...
"[project]/src/lib/reviewsData.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
_c1 = GoogleIcon;
const TrustpilotIcon = ()=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
const SummaryCard = ({ platform, rating, reviewCount })=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        className: "text-sm text-slate-500",
                                        children: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$formatDistanceToNow$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatDistanceToNow"])(new Date(review.date), {
                                            addSuffix: true
                                        })
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/testimonials/page.tsx",
...
_s(MobileFilterDrawer, "OD7bBpZva5O2jO+Puf00hKivP7c=");
_c5 = MobileFilterDrawer;
function ReviewsPage() {
    ...
    const [isFilterOpen, setIsFilterOpen] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false); // State for mobile drawer
    const filteredAndSortedReviews = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ReviewsPage.useMemo[filteredAndSortedReviews]": ()=>{
            let reviews = [
                ...__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$reviewsData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["reviewsData"]
            ];
            if (filters.rating === 'below-4') {
                reviews = reviews.filter({
                    "ReviewsPage.useMemo[filteredAndSortedReviews]": (r)=>r.rating < 4
                }["ReviewsPage.useMemo[filteredAndSortedReviews]"]);
            } else if (filters.rating !== 'all') {
                reviews = reviews.filter({
                    "ReviewsPage.useMemo[filteredAndSortedReviews]": (r)=>Math.floor(r.rating) === filters.rating
                }["ReviewsPage.useMemo[filteredAndSortedReviews]"]);
            }
            if (filters.platform !== 'all') {
                reviews = reviews.filter({
                    "ReviewsPage.useMemo[filteredAndSortedReviews]": (r)=>r.platform === filters.platform
                }["ReviewsPage.useMemo[filteredAndSortedReviews]"]);
            }
            if (filters.year !== 'all') {
                reviews = reviews.filter({
                    "ReviewsPage.useMemo[filteredAndSortedReviews]": (r)=>new Date(r.date).getFullYear() === filters.year
                }["ReviewsPage.useMemo[filteredAndSortedReviews]"]);
            }
            reviews.sort({
                "ReviewsPage.useMemo[filteredAndSortedReviews]": (a, b)=>{
                    switch(filters.sort){
                        case 'oldest':
    ...
    const calculateStats = (platform)=>{
        const platformReviews = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$reviewsData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["reviewsData"].filter((r)=>r.platform === platform);
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$components$2f$AnimatePresence$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AnimatePresence"], {
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
                                ...
                                children: filteredAndSortedReviews.slice(0, visibleCount).map((review)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(ReviewCard, {
                                        review: review
                                    }, review.id, false, {
                                        fileName: "[project]/src/app/testimonials/page.tsx",
                                        lineNumber: 318,
...
__turbopack_context__.k.register(_c2, "TrustpilotIcon");
__turbopack_context__.k.register(_c3, "SummaryCard");
__turbopack_context__.k.register(_c4, "ReviewCard");
__turbopack_context__.k.register(_c5, "MobileFilterDrawer");
...
//# sourceMappingURL=_bd9b0b42._.js.map