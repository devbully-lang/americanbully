    ...
    const filteredAndSortedReviews = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ReviewsPage.useMemo[filteredAndSortedReviews]": ()=>{
            ...
            if (filterRating === 'below-4') {
                ...
                reviews = reviews.filter({
                    "ReviewsPage.useMemo[filteredAndSortedReviews]": (r)=>Math.floor(r.rating) === filterRating
                }["ReviewsPage.useMemo[filteredAndSortedReviews]"]);
            }
            if (filterPlatform !== 'all') {
                reviews = reviews.filter({
                    "ReviewsPage.useMemo[filteredAndSortedReviews]": (r)=>r.platform === filterPlatform
                }["ReviewsPage.useMemo[filteredAndSortedReviews]"]);
            }
            if (filterYear !== 'all') {
                reviews = reviews.filter({
                    "ReviewsPage.useMemo[filteredAndSortedReviews]": (r)=>new Date(r.date).getFullYear() === filterYear
                }["ReviewsPage.useMemo[filteredAndSortedReviews]"]);
            }
            // Sorting Logic
            reviews.sort({
...
_s(ReviewsPage, "NHLFrOJKSQP67PttpnOb0WKbH5Q=");
_c5 = ReviewsPage;
...
__turbopack_context__.k.register(_c5, "ReviewsPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=_e80a626f._.js.map